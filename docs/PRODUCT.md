...
| Generic Docker executor | Narrow Python/pytest contract | Verified in CI on `ubuntu-24.04` (one scoped fixture check in the built image); not proven live |
