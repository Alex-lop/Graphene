...
| Terminal UI (`graphene ui`) | `NOT PROVEN` | Not built yet; scheduled for 2026-08-27. `docs/assets/ui-terminal.png` is a labelled placeholder until a real capture replaces it |
