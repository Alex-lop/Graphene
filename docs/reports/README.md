...
| 2026-08-26 | [Goal run](2026-08-26-goal-run.md) | The door, the face, and `/graphene`: README rewritten for a newcomer with the proof table moved to `docs/PROOF.md`, Shadow Agent deleted with a receipt, role-first module renames, then `graphene ui` and the MCP `goal` loop | In progress — read the report's STATE block |
